...
license_url = 'https://raw.githubusercontent.com/KSXGitHub/strip-ansi-cli/master/LICENSE.md'
...
with open('./pkgbuild/strip-ansi/PKGBUILD', 'w') as pkgbuild:
  ...
  content += f'source=(strip-ansi-{release_tag}.tar.gz::{source_url} {license_url})\n'
...
with open('./pkgbuild/strip-ansi-bin/PKGBUILD', 'w') as pkgbuild:
  ...
  content += f'source=(strip-ansi-{checksum}::{source_url} {completions} {license_url})\n'
